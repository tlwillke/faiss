...
struct Level1Quantizer {
    ...
    Level1Quantizer& operator=(Level1Quantizer&&) = delete;
};
...
struct IndexIVFInterface : Level1Quantizer {
    ...
    IndexIVFInterface& operator=(IndexIVFInterface&&) = delete;
};
...
struct IndexIVF : Index, IndexIVFInterface {
    ...
    IndexIVF& operator=(IndexIVF&&) = delete;
...
struct IndexIVFStats {
    ...
    size_t nlist = 0;             // nb of inverted lists scanned
    size_t ndis = 0;              // nb of distances computed
    size_t nheap_updates = 0;     // nb of times the heap was updated
    double quantization_time = 0; // time spent quantizing vectors (in ms)
    double search_time = 0;       // time spent searching lists (in ms)
